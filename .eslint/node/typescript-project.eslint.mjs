...
const tsconfigRootDirectory = path.join(
...
const tsconfigScriptsPath = path.join(
...
if (!fs.existsSync(tsconfigPath)) {
  logger.warn(
    `Warning: tsconfig.json not found at ${tsconfigPath}. Please ensure the path is correct.`,
  );
}
